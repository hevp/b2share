...
migrate_2_1_x_to_2_2_0 = UpgradeRecipe('2.1', '2.2.0')

@migrate_2_1_x_to_2_2_0.step(
    lambda alembic, *args:
...
def alembic_upgrade_database_data(alembic, verbose):
    """Migrate the database data from v2.1.x to 2.2.0."""
    ### Add versioning PIDs ###
...
def migrate_community_metadata(record, parent_pid):
    """Migrate a community's metadata to 2.2.0 format."""
...
migrate_2_1_x_to_2_2_0.step()(fix_communities)
